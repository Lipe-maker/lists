...
def display_message(heading_text, sub_heding_text):
    screen.draw.text(heading_text, fontsize=60, center=CENTRE, color='white')
    screen.draw.text(sub_heding_text, fontsize=30, center=(CENTRE_X, CENTRE_Y + 30), color='white')
